...
import { fetchPosts, postPost, deletePost, editPost } from "../3redux/ActionCreators";
import MappedPost from "./MappedPostComponent";

const ReduxAxiosPostComponent = () => {
    ...
    const postsData = useSelector(state => state.postsDataAxios.postsData);
    ...
    return(
        <div>
            <h1>React Hooks Axios Version</h1>
...
export default ReduxAxiosPostComponent;